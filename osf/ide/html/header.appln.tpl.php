...
<head>
	...
	<link href="../ide/css/index.php" rel="stylesheet" type="text/css" />
	<script src="../ide/js/jquery-1.4.2.min.js" type="text/javascript"></script>
	<script src="../ide/js/jquery-ui-1.8.custom.min.js" type="text/javascript"></script>
	<script src="../ide/js/jquery.validate.js" type="text/javascript"></script>
	<script language="javascript" type="text/javascript" src="../ide/js/edit_area/edit_area_full.js"></script>
          ...
          <div class="container osf-navbar-img-sm">
            ...
            <div id="navbar" class="navbar-collapse collapse">
			  <ul class="nav navbar-nav navbar-right">
		        <li><a href="https://www.batoi.com/opendelight/docs/installation.php"><i class="fa fa-info-circle"></i></a></li>
			</ul>
            </div><!--/.nav-collapse -->
          </div>
	  </nav>
