<div class="container" role="main">
	...
	<?php } else { ?>
	<div class="alert alert-info" role="alert">Please fill up the following form to create a new Script Includes.</div>
	<?php } ?>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<form role="form" name="frmAppClassAdd" id="frmAppClassAdd" action="<?php print $_SERVER['PHP_SELF'].'?ID=36';?>" method="post">
				<div class="row">
					<div class="col-lg-12 osf-content-left">
						<div class="form-group">
							<label>Script Include Name</label>
			                <input type="text" name="txtSIName" id="txtSIName" value="<?php if (isset($_POST['txtSIName'])) print $_POST['txtSIName'];?>" class="form-control required space" />
							<p class="help-block">(File name must have .inc.php appended. Cannot be edited later.)</p>
			            </div>
					</div>
				</div>
